...
if(currentTime<1500){
   consigne_pos=1883;
    ...
    consigne_posgauche=2400+1883;
    }
    if(currentTime>3000&&currentTime<4500){
   consigne_pos=2*1883;
    consigne_posgauche=4283+1883;
    }
    if(currentTime>4500&&currentTime<6000){
  
    consigne_posgauche=6250+2400;
    }
    if(currentTime>6000&&currentTime<7500){
   consigne_pos=3*1883;
    consigne_posgauche=8500+1883;
    }
    if(currentTime>7500&&currentTime<9000){
   
   consigne_posgauche=10449+2400;
    }
    if(currentTime>9000&&currentTime<10500){
   consigne_pos=4*1883;
